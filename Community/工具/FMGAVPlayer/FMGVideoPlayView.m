...
//            [self showToolView:YES];
    ...
    [UIView animateWithDuration:1.0 animations:^{
        ...
        self.clostBtn.alpha = self.isShowToolView;
    }];
}
...
//    self.hidden = YES;
//    [self.player pause];
//   __weak FMGVideoPlayView *weakSelf = self;
//    [self.player seekToTime:kCMTimeZero completionHandler:^(BOOL finished) {
//        [weakSelf.progressSlider setValue:0.0 animated:YES];
//        weakSelf.playOrPauseBtn.selected = YES;
//    }];
    
    [self.delegate close:self.fullbtn.selected];
