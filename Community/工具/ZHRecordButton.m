...
- (void)initial {
    ...
    [self setTitle:@"按住 录音" forState:UIControlStateNormal];
...
- (void)touchDragEnter:(UIButton *)button {
    ...
    [self.recordTool updateHUDTitle:@"手指上滑,取消发送!"];
    [self.recordTool updateHUDTitleColor:[UIColor clearColor]];
...
- (void)touchDragExit:(UIButton *)button {
    ...
    [self.recordTool updateHUDImageView:@"ZHRecor.bundle/record_revocation.png"];
    [self.recordTool updateHUDTitleColor:[UIColor redColor]];
}
